...
|--------+---------------+-------------------------------|
| [[file:../../nix/home-manager/mods/opencode.nix][opencode.nix]] | =opencode.enable=, package, =--yolo= policy wrapper, and llm-log routing | Home Manager's =programs.opencode=: settings, TUI, web service, context, commands, agents, skills, themes, tools, extra packages, and shared MCP integration |
