...
| Qtile workflows | [[file:../../.config/qtile/qtile-workflows.org][.config/qtile/qtile_workflows.org]] | Desktop workflow lifecycle/actions and definitions; tangles to =qtile_workflows.py= and =workflows.json=. |
| Qtile routing | [[file:../../.config/qtile/qtile-ai-windows.org][.config/qtile/qtile-ai-windows.org]] | Topology-aware window metadata classifiers; tangles to =qtile_ai_windows.py=. |
