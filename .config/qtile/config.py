...
keys.extend(
    [
        ...
        Key([], "Print", lazy.spawn("spectacle --fullscreen --background --nonotify"), desc="Capture desktop"),
        Key([mod], "Print", lazy.spawn("spectacle --region --background --nonotify"), desc="Capture region"),
