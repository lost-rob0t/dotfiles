...
and OpenRouter installation are unchanged. The adjacent z.AI/Codex pair is added
...
The [[file:qtile-consortium.org][Consortium observer pair]] is installed on the primary screen before subscription telemetry.
The [[file:qtile-llm-log-graph.org][new llm-log API grapher]] is installed directly after Codex.
