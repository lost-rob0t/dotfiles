...
let
  ...
  commandSpecs = {
    ...
    memory = [
      "Query project KB and shared Org-roam memory"
      "prolog-project-kb"
    ];
    remember = [
      "Persist a reusable verified fact to the correct project/shared memory scope"
      "prolog-project-kb"
    ];
    forget = [
      "Deprecate project or shared memory safely"
      "prolog-project-kb"
    ];
    learn = [
      "Promote worthwhile session knowledge to the correct memory scope"
      "prolog-project-kb"
    ];
    handoff = [
