...
the glibc compatibility guest for AI tools, installs the full Termux Doom
profile, exposes a Doom-free Org-first Emacs launcher, and creates Termux:Widget
shortcuts.
