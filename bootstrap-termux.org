...
=bootstrap-termux.sh= detects the phone environment, installs the native language
toolchain, provisions the glibc compatibility guest for AI tools, installs the
Termux Doom profile, and creates Termux:Widget shortcuts.
