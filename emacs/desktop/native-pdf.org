#+TITLE: Native PDF Module
#+STARTUP: overview
#+PROPERTY: header-args:emacs-lisp :comments no :padline yes :mkdirp yes

Native equivalent of the enabled Doom =:tools pdf= behavior.  Keep this small;
PDFs should open like they did in Doom without loading Doom itself.

* Runtime
#+begin_src emacs-lisp :tangle autoload/native-pdf.el
