...
This is the native desktop UX contract.  It deliberately recreates the visible
and muscle-memory parts of the enabled Doom modules without loading Doom itself.
