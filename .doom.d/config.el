...
(autoload #'ai/roam-memory-recall "ai-roam-memory" nil t)
(autoload #'ai/roam-profiles-apply "ai-roam-profiles" nil t)
...
(after! org-roam
  (map! :localleader
        ...
        :desc "Recall memory" "m" #'ai/roam-memory-recall
        :desc "Apply roam AI profile" "r" #'ai/roam-profiles-apply))
