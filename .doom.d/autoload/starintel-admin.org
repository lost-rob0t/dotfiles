...
#+property: header-args:emacs-lisp :tangle ./starintel-admin.el :results none

This is the literate source for the standalone StarIntel administrator major
mode. It intentionally does not replace the user's normal startup dashboard.
